...
\end{equation} 
which is dependent on the Centrifugal potential \(\mathrm{L^2/2r^2}\) (taken from \citet[p. 59, eq. 6.27]{bartelmann}). The Centrifugal potential describes the energy of the star which it obtains due to its rotation.
\begin{figure}[htbp]
\centering
