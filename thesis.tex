...
\begin{subfigure}{0.95\textwidth}
	\centering
  	\includegraphics[width=\textwidth]{Plots/position_scatter_plot_IMBH1.pdf}
  	\caption{SIM 1. The \ac{GC} is spread until 100 pc with most of the stars located in the inner 40 pc.}
 	\label{fig:pos_scat_SIM1}
\end{subfigure}
\vskip\baselineskip
%\begin{subfigure}{0.95\textwidth}
%	\centering
% \includegraphics[width=\textwidth]{Plots/position_scatter_plot_IMBH2.pdf}
%  	\caption{SIM 2. It is spread until ... pc.}
% 	\label{fig:pos_scat_SIM2}
%\end{subfigure}
%\vskip\baselineskip
\begin{subfigure}{0.95\textwidth}
	\centering
  	\includegraphics[width=\textwidth]{Plots/position_scatter_plot_noIMBH1.pdf}
  	\caption{SIM 3. The \ac{GC} is spread until 90 pc.}
 	\label{fig:pos_scat_SIM3}
\end{subfigure}
\vskip\baselineskip
\begin{subfigure}{0.95\textwidth}
	\centering
  	\includegraphics[width=\textwidth]{Plots/position_scatter_plot_noIMBH2.pdf}
  	\caption{SIM 4. The \ac{GC} is spread until 60 pc.}
 	\label{fig:pos_scat_SIM4}
\end{subfigure}
\caption{Position scatter plots. The stars are distributed spherically with most of the stars in the inner part. The stars of the \ac{GC} with \ac{IMBH} are less spread in the outer parts despite very few which are far outside. In the \ac{GCs} without \ac{IMBH} the stars in the outer part are less accumulated but the furthermost stars still in the main sphere.}
...
\begin{subfigure}{0.95\textwidth}
	\centering
  	\includegraphics[width=\textwidth]{Plots/velocity_scatter_IMBH1.pdf}
  	\caption{SIM 1. The stars' velocities are spread until 120 km/s with most of them reaching 30 km/s.}
 	\label{fig:vel_scat_SIM1}
\end{subfigure}
\vskip\baselineskip
%\begin{subfigure}{0.95\textwidth}
%	\centering
% \includegraphics[width=\textwidth]{Plots/velocity_scatter_plot_IMBH2.pdf}
%  	\caption{SIM 2. The stars' velocities are spread until 40 km/s.}
% 	\label{fig:vel_scat_SIM2}
%\end{subfigure}
%\vskip\baselineskip
\begin{subfigure}{0.95\textwidth}
	\centering
  	\includegraphics[width=\textwidth]{Plots/velocity_scatter_noIMBH1.pdf}
  	\caption{SIM 3. The stars' velocities are spread until 15 km/s.}
 	\label{fig:vel_scat_SIM3}
\end{subfigure}
\vskip\baselineskip
\begin{subfigure}{0.95\textwidth}
	\centering
  	\includegraphics[width=\textwidth]{Plots/velocity_scatter_noIMBH2.pdf}
  	\caption{SIM 4. The stars' velocities are spread until 40 km/s.}
 	\label{fig:vel_scat_SIM4}
\end{subfigure}
\caption{Velocity scatter plots. The velocities are spherically distributed. Most of the stars have low or no velocity while a few have high velocities in different directions. Like the star distribution the velocity distribution of the \ac{GC} with \ac{IMBH} has some velocities outside the main sphere whereas the \ac{GCs} without \ac{IMBH} contains all velocities inside the main shell.}
